...
local function createLoadingScreen()
    ...
    -- Título "veloz Hub" com efeito brilhante
    ...
    heartbeatConnection = RunService.Heartbeat:Connect(function()
        ...
        if finished then
            ...
            fadeTween.Completed:Connect(function()
                ...
                game:GetService("ReplicatedStorage").RE["1RPNam1eTex1t"]:FireServer(table.unpack({
                    [1] = "RolePlayBio",
                    [2] = "Criador: Equipe veloz Hub",
                }))
                
                -- Exibe a notificação de boas-vindas
                StarterGui:SetCore("SendNotification", {
                    Title = "velozHub",
                    Text = "Bem-vindo ao veloz Hub!",
                    Duration = 4
                })
...
local Libary = loadstring(game:HttpGet("https://pastebin.com/raw/XqZsnzRQ", true))()
workspace.FallenPartsDestroyHeight = -math.huge

local Window = Libary:MakeWindow({
    Title = "veloz Hub | Brookhaven RP ",
    SubTitle = "by theo666",
    LoadText = "Loading veloz Hub",
    Flags = "veloz_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://93233024836802", BackgroundTransparency = 0 },
...
InfoTab:AddParagraph({ "Owner / Developer:", "theo" })
InfoTab:AddParagraph({ "Collaborations:", "mateus" })
InfoTab:AddParagraph({ "You are using:", "veloz Hub Brookhaven " })
...
InfoTab:AddDiscordInvite({
    Name = "veloz Hub",
    Description = "https://discord.gg/tEk7ASbKZ",
    Logo = "rbxassetid://93233024836802",
    Invite = "https://discord.gg/tEk7ASbKZ",
})
...
Tab16:AddButton({
    ...
    Callback = function()
       loadstring(game:HttpGet("https://pastefy.app/HoNqkWZO/raw"))()
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Painel Admin",
